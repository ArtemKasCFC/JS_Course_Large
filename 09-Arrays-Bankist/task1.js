...
const checkDogs = (dogsJulia, dogsKate) => {
  let onlydogs = [...dogsJulia];
  onlydogs = onlydogs.slice(1, 3);
  //   onlydogs.splice(0, 1);
  //   onlydogs.splice(-2);

  const dogsAll = [...onlydogs, ...dogsKate];

  dogsAll.forEach((age, ind) =>
    age >= 3
      ? console.log(`Dog number ${ind + 1} is an adult, and is ${age} years old`)
